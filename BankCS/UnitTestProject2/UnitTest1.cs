...
namespace UnitTestProject1
{
    ...
    public class forumTests
    {
        ...
        public void ChangePolicyTest()
        {
            ...
            system.init("Ferguson", "scottishAccent", "alex@fer", "fergi", "england.manchster");
            system.createForum("Ferguson", "scottishAccent", "First Forum", 2);
            Boolean changed = false;//system.changePolicy("Ferguson", "scottishAccent", "First Forum", 1);
        ...
        public void AnonymousConnectTest()
        {
            ...
            List<string> listSubForums = system.subForumList("First Forum");
            List<string> recievedSubForums = system.anonymousConnect("First Forum");
            Assert.AreEqual(recievedSubForums.Count, 2, 0, "guest recieved a list of two sub forums");
        ...
        public void ReplyTest()
        {
            ...
            List<string> lst = forum.AllPostreplies("Manchester United", "Champ19ns", "i got my 10 thropy", "wazza", "10");
        ...
        public void MailConfirmTest()
        {
            ...
            List<string> lst = forum.subForumPosts("wazza", "10", "Manchester United", "Champ19ns");
            Assert.AreEqual(lst.Count, 1, 0, "there is only one post");
            Int64 i = forum.register("Manchester United", "wazza", "10", "wayne rooney", "rooney@manU.com");
        ...
        public void DeleteSubForumTest()
        {
            ...
            Assert.AreEqual(forum.subForumList("Manchester United").Count, 1, 0, "even the moderator cant delete his subforum");
            forum.deleteSubForum("giggsy", "11", "Manchester United", "Champ19ns");
            Assert.AreEqual(forum.subForumList("Manchester United").Count, 0, 0, "admin can delete delete subforum");
            VidicDis(forum);
        }
