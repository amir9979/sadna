...
namespace dd
{
    public abstract  class ForumSystem
    {
        ...
        abstract public IList<PostInfo> WatchAllThreads(User u, SubForumInfo s); //use case need to implements

        abstract public IList<PostInfo> WatchAllComments(User u, PostInfo s); //use case need to implements
        ...
        abstract public IList<ForumInfo> WatchAllForums(User u);
